    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
            <div class="navbar-collapse-header">
                ...
                <a class="nav-link text-white " href="http://192.168.12.83:237/accounts/search/" role="button">
                ...
                <?php elseif(isset($_SESSION['des']) && $_SESSION['des'] == 3): ?>
                    <ul class="navbar-nav align-items-lg-center ml-auto topnav" id="nav">
                    <a class="nav-link text-white " href="update_cap.php" role="button">
                    <span class="text-white nav-link-inner--text"><i class="text-white fas "></i>Update Capacity Of CropBank</span> </a>                                                         
                    <a class="nav-link text-white " href="register_cropbank.php" role="button">
                    <span class="text-white nav-link-inner--text"><i class="text-white fas "></i>Register As A CropBank</span> </a>                                                         
                    <a href="profile.php"><img src="p.png" alt="profileimg" width="50"></a> 
                <?php endif; ?>
            </ul>
        </div>
