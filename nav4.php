    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
            <div class="navbar-collapse-header">
                ...
                <a class="nav-link text-white " href="sland.php" role="button">
                    <span class="text-white nav-link-inner--text"><i class="text-white fas "></i>Find Land</span> </a>
                ...
                <?php elseif(isset($_SESSION['des']) && $_SESSION['des'] == 4): ?>
                    <ul class="navbar-nav align-items-lg-center ml-auto topnav" id="nav">
                    <a class="nav-link text-white " href="register_sland.php" role="button">
                    <span class="text-white nav-link-inner--text"><i class="text-white fas "></i>Register Your Land</span> </a>                                                         
                    <a class="nav-link text-white " href="register_sland.php" role="button">
