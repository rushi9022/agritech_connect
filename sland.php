...
<body>    
    <div class="container mt-3">
        <center><h1>Search Available Lands Near To You</h1></center>
        ...
        <div class="row">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "GET") {
                if (isset($_GET['city']) && !empty($_GET['city'])) {
                    ...
                    $cityQuery = "SELECT latitude, longitude FROM sland WHERE city = '$city'";
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">                                            
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Water Available: <?php echo $row['crop_type']; ?></p>                                                
                                                <p class="card-text">Available Land: <?php echo $row['capacity']; ?> Acre</p>
                                                <button class="btn btn-primary btn-contact" data-toggle="modal" data-target="#contactModal<?php echo $row['id']; ?>">Contact</button>
                                                <button class="btn btn-primary btn-contact" onclick="openPDF('<?php echo $row['pdf_path']; ?>')">View Documents</button>
                                                <!-- Modal -->
    ...
    <script>
        function openPDF(pdfFilePath) {
            // Replace '_blank' with '_self' if you want to open the PDF in the same tab/window
