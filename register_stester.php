...
<head>
    ...
    <title>CropBank Registration</title>
    <style>
        body {
...
<body>
    <center><h2>Register As a Soil Tester</h2></center> 
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
        ...
        <label for="crop_type">Soil Type:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO sdata (name, city, crop_type, capacity, contact_number, email, address, image, latitude, longitude) 
